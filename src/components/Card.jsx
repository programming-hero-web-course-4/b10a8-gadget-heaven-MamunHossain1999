  ...
  return (
    ...
    <div className="   transition hover:scale-105 card bg-base-100  mx-auto shadow-xl mt-3">
            ...
            <div className="card-body">
                    ...
                    <div>  <Link to={ `/product/ ${product_id}`} > <button className='btn border-purple-700 text-purple-500 rounded-3xl' >View Details</button></Link></div>
                </div>
        </div>
